...
class FacebookApiUrls(object):
	...
	@classmethod
	def oauth_code__url_dialog(cls, app_id, scope, redirect_uri):
	...
	@classmethod
	def oauth_code__url_access_token(cls, fb_graph_api, app_id, redirect_uri, client_secret, code):
	...
	@classmethod
	def oauth__url_extend_access_token(cls, fb_graph_api, app_id, client_secret, access_token):
	...
	@classmethod
	def graph__action_create_url(cls, fb_graph_api, fb_fb_app_namespace, fb_action_type_name):
